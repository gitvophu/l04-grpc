...
class GreeterClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Helloworld\HelloRequest2 $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function SayHello2(\Helloworld\HelloRequest2 $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/helloworld.Greeter/SayHello2',
        $argument,
        ['\Helloworld\HelloReply', 'decode'],
        $metadata, $options);
    }
