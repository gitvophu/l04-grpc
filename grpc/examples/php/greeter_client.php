...
@include_once dirname(__FILE__).'/Helloworld/HelloRequest2.php';
...
function greetAgain($name)
{
    ...
    $request = new Helloworld\HelloRequest2();
    $request->setName($name);
    $request->setAge('name 2222');
    echo $request->getAge();exit;
